                       ...
                       sidebarPanel(width = 6, 
                                    p("This dataset focuses on various streaming services", em("(Netflix, Hulu, Prime Video,"), "and", em("Disney+)"), 
                                      ...
                                      nrow(fullData), "movies", "Each tab shown here displays different information. The first tab shows general info about 
                                                     this dataset and lets the user pick how many random rows of data to show (numbner of movies and data about them to show specifically), 
                                      the second tab shows a bar graph that can be interacted with that",
                                      ...
                                      "The fourth pannel shows", strong("all the data"), "including movie titles, movie ratings, the year the
                                                            movie is from, if streaming platforms have the movie or not, and more."), sliderInput("rows", h4(strong("Number of Random Movies to Show")), min = 1, max = nrow(fullData), value = 1), 
                                    h4(strong(textOutput("randRowsText")))), 
                       mainPanel(width = 6, dataTableOutput("selectedRows"))
              ), 
              tabPanel("Graph",
